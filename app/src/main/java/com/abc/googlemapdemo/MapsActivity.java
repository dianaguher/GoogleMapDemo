...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
  ...
  /*  public void onMapReady(GoogleMap googleMap) {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //LatLng sydney = new LatLng(-34, 151);
        LatLng rtvLiberia = new LatLng(10.6088762, -85.4326206);
        System.out.println(new MarkerOptions().position(rtvLiberia).getTitle());

        googleMap.addMarker(new MarkerOptions().position(rtvLiberia).title("RTV Liberia"))
                .setIcon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_ORANGE));
        googleMap.moveCamera(CameraUpdateFactory.newLatLng(rtvLiberia));
